...
export const PERMISSION_TREE = [
  ...
  {
    key: 'requisition', label: 'Requisition', children: [
      { key: 'requisition.clear-all', label: 'Clear all data' },
      { key: 'requisition.print', label: 'Print' },
      { key: 'requisition.action', label: 'Action' }
    ]
  },
  {
